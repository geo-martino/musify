...
a=0 
find "/mnt/d/Pictures/2022" -maxdepth 1 \
    -iname '*.jpg' -print0 -o -iname '*.jpeg' -print0 -o \
    -iname '*.png' -print0 -o  -iname '*.bmp' -print0 -o \
    -iname '*.mp4' -print0 -o  -iname '*.mov' -print0 -o \
    -iname '*.avi' -print0 | while read -d $'\0' file
do
    echo "$file" $a 
    a=$((a+1))
done
