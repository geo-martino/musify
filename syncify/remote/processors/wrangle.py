...
class RemoteDataWrangler(Remote, metaclass=ABCMeta):
    ...
    @classmethod
    def get_item_type(cls, values: APIMethodInputType, kind: RemoteItemType | None = None) -> RemoteItemType:
        """
        ...
        :param kind: The :py:class:`RemoteItemType` if the value is found to be an ID.
