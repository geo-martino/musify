...
1. Load your library:
   ...
   .. literalinclude:: _howto/scripts/local.library.load/p1.py
      :language: Python
      :lines: 3-

2. Get collections from your library:

   .. literalinclude:: _howto/scripts/local.library.load/p2.py
      :language: Python
      :lines: 3-

3. Get a track from your library using any of the following identifiers:

   .. literalinclude:: _howto/scripts/local.library.load/p3.py
      :language: Python
      :lines: 3-
