...
2. Backup your library to JSON:
   ...
   .. literalinclude:: scripts/local.library.backup-restore/p1.py
      :language: Python
      :lines: 3-

3. Restore the tags for all tracks in your library from a JSON file:

   .. literalinclude:: scripts/local.library.backup-restore/p2.py
      :language: Python
      :lines: 3-

   ... or restore only a specific set of tags:

   .. literalinclude:: scripts/local.library.backup-restore/p3.py
      :language: Python
      :lines: 3-

4. Save the tags to the track files:

   .. literalinclude:: scripts/local.library.backup-restore/p4.py
      :language: Python
      :lines: 3-
...
2. Backup your library to JSON:
   ...
   .. literalinclude:: scripts/spotify.library.backup-restore/p1.py
      :language: Python
      :lines: 3-

3. Restore the playlists in your library from a JSON file and sync the playlists:

   .. literalinclude:: scripts/spotify.library.backup-restore/p2.py
      :language: Python
      :lines: 3-
