...
class PathMapper(PrettyPrinter):
    ...
    def maps(self, values: Collection[str | File | None], check_existence: bool = False) -> list[str]:
    ...
    def unmaps(self, values: Collection[str | File | None], check_existence: bool = False) -> list[str]:
