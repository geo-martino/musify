...
from syncify.local.track.flac import FLAC
from syncify.local.track.m4a import M4A
from syncify.local.track.mp3 import MP3
from syncify.local.track.wma import WMA
